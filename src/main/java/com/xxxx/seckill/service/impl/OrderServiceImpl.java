...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements IOrderService {
    ...
    public Order seckill(User user, GoodsVo goods) {
        ...
        boolean seckillGoodsResult = seckillGoodsService.update(new
                UpdateWrapper<SeckillGoods>().setSql("stock_count="+"stock_count-1").eq("goods_id",goods.getId()).gt("stock_count",
                0));
    ...
    @Override
    public boolean checkCapcha(User user, Long goodsId, String captche) {
        if(null==user||goodsId<0||StringUtils.isEmpty(captche)){
            return false;
        }
        String redisCaptcha = (String) redisTemplate.opsForValue().get("captcha:" + user.getId() + ":" + goodsId);
        return captche.equals(redisCaptcha);
    }
}
